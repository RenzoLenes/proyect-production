...
import { processes } from "@/lib/types/process";
...
import { Empresa } from "@/features/empresa/types/empresa.interface";
...
import { getFolderByTipo } from "@/features/folder/actions/crud-folder";
import { TipoCorte } from "@/features/tipo-corte/types/tipocorte.interface";
import { getPrendasPorProcesoParams, RptPrendasProcesoTransformed } from "@/features/reportes/types/rpt-prendas-proceso.interface";
import { getCalidadByTipo } from "@/features/calidad/actions/crud-calidad";
import { getAllTiposCorte } from "@/features/tipo-corte/actions/crud-tipocorte";
import { getPrendasPorProceso } from "@/features/reportes/actions/get-prendas-proceso";
import { getEmpresaById } from "@/features/empresa/actions/crud-empresa";
...
export default function DashboardPage() {
  ...
  const [prendasPorProceso, setPrendasPorProceso] = useState<RptPrendasProcesoTransformed[]>([]);
